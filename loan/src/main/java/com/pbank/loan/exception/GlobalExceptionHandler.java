package com.pbank.loan.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDto> handleLoansAlreadyExistsException(LoanAlreadyExistsException exception, WebRequest request){
